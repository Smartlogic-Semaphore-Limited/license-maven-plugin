    ...
    DownloadLicensesMojo
{
    ...
    private AboutFileLicenseResolver aboutFileLicenseResolver = new AboutFileLicenseResolver();
	...
	throws IOException
    {
	License license = aboutFileLicenseResolver.resolve( artifact.getArtifactId(), jarFile );
	if ( license != null )
	{
